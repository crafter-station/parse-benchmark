...
function createCrafterLogoSvg(size: number, color: string = BRAND.foreground): string {
      ...
      <g>
        ...
        <g transform="translate(${panelX + 24}, ${panelTop + 12})">
          ...
          <g transform="translate(0, 0)">
            ${createCrafterLogoSvg(logoSize, BRAND.foreground)}
          </g>
        ...
        <g transform="translate(${width / 2}, ${panelTop + headerHeight + (panelHeight - headerHeight) / 2 + 20})">
          ...
          <g transform="translate(-48, -100)">
            ${createCrafterLogoSvg(96, BRAND.foreground)}
          </g>
...
async function main(): Promise<void> {
  ...
  console.log(`  Foreground: ${BRAND.foreground} (logo color)`);
  console.log('');
